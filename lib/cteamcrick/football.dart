...
class CteamFootball extends StatefulWidget {
  const CteamFootball({Key? key}) : super(key: key);

  @override
  _CteamFootballState createState() => _CteamFootballState();
}

class _CteamFootballState extends State<CteamFootball> {
  @override
