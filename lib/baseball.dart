...
class CteamBaseball extends StatefulWidget {
  const CteamBaseball({Key? key}) : super(key: key);

  @override
  _CteamBaseballState createState() => _CteamBaseballState();
}

class _CteamBaseballState extends State<CteamBaseball> {
  @override
